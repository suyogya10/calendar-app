...
const CalendarBottomNav: React.FC<CalendarBottomNavProps> = ({ view, setView }) => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-white/90 backdrop-blur-xl border-t border-zinc-200/60 z-50 px-10 pb-safe flex items-center justify-between shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)]">
